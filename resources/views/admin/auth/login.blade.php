        ...
        <div class="row align-items-center h-100">
            ...
            <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" method="POST" action="{{ route('admin.login') }}">
                ...
                <div class="form-group">
                    <label for="inputUsername" class="sr-only">{{ __('keywords.username') }}</label>
                    <input type="text" id="inputUsername" class="form-control form-control-lg"
                           placeholder="{{ __('keywords.username') }}" name="username" :value="old('username')" required autofocus>
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="inputPassword" class="form-control form-control-lg"
                           placeholder="{{ __('keywords.password') }}" name="password" required>
